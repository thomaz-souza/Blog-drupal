...
/* themes/contrib/classy/templates/form/datetime-wrapper.html.twig */
class __TwigTemplate_eb0f5e0b2a538de60ca8ef1b2175e677 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["description"] ?? null)) {
            // line 33
            echo "  <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["description_attributes"] ?? null), "addClass", ["description"], "method", false, false, true, 33), 33, $this->source), "html", null, true);
            echo ">
    ";
            // line 34
...
";
    ...
    {
        return "themes/contrib/classy/templates/form/datetime-wrapper.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/classy/templates/form/datetime-wrapper.html.twig", "C:\\xampp\\htdocs\\Blog-drupal\\web\\themes\\contrib\\classy\\templates\\form\\datetime-wrapper.html.twig");
    }
