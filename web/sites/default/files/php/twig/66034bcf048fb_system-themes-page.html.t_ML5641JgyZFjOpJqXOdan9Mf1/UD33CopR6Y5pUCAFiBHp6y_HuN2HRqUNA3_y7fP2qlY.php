...
class __TwigTemplate_f2142ce0f4643cac47e137690fb48500 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["theme_group"]) {
            ...
            echo "    ";
            // line 35
            $context["theme_group_classes"] = ["system-themes-list", ("system-themes-list-" . $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source,             // line 37
$context["theme_group"], "state", [], "any", false, false, true, 37), 37, $this->source)), "clearfix"];
            // line 41
            echo "    <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["theme_group"], "attributes", [], "any", false, false, true, 41), "addClass", [($context["theme_group_classes"] ?? null)], "method", false, false, true, 41), 41, $this->source), "html", null, true);
            echo ">
      ...
      ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["theme"]) {
                ...
                echo "        ";
                // line 45
                $context["theme_classes"] = [((twig_get_attribute($this->env, $this->source,                 // line 46
$context["theme"], "is_default", [], "any", false, false, true, 46)) ? ("theme-default") : ("")), ((twig_get_attribute($this->env, $this->source,                 // line 47
$context["theme"], "is_admin", [], "any", false, false, true, 47)) ? ("theme-admin") : ("")), "theme-selector", "clearfix"];
                // line 52
                echo "        <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["theme"], "attributes", [], "any", false, false, true, 52), "addClass", [($context["theme_classes"] ?? null)], "method", false, false, true, 52), 52, $this->source), "html", null, true);
                echo ">
          ";
                // line 53
...
";
    ...
    {
        return new Source("", "themes/contrib/stable/templates/admin/system-themes-page.html.twig", "C:\\xampp\\htdocs\\Blog-drupal\\web\\themes\\contrib\\stable\\templates\\admin\\system-themes-page.html.twig");
    }
