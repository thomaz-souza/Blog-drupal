...
class __TwigTemplate_fa3d6fac7f0f595fce2703935da35fe3 extends Template
{
    private $source;
    private $macros = [];
...
($context["required"] ?? null)) ? ("form-required") : (""))];
            // line 26
            echo "    <summary";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["summary_attributes"] ?? null), "addClass", [($context["summary_classes"] ?? null)], "method", false, false, true, 26), 26, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return new Source("", "themes/contrib/classy/templates/form/details.html.twig", "C:\\xampp\\htdocs\\Blog-drupal\\web\\themes\\contrib\\classy\\templates\\form\\details.html.twig");
    }
